...
public class WalletManager : MonoBehaviour
{
    ...
    //chiprace contract for mutated cars
    private string mutantChipraceContract = "0xFfE54820160e97f8AC4e39a0cC4a41D4303eF284";
    ...
    private void OnEnable()
    {
        ...
        if (Constants.IsTestNet)
        {
            ...
            CSPContract = "0xA7209667B33742861c67A31cc1181B49f2D34f4a";
